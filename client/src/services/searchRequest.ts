...
export function createSearchRequest(queryStr: string = "", page: number = 1) {
  return {
...
export async function postSearchRequest(query: string, page: number = 1) {
  const request = createSearchRequest(query, page);
  try {
